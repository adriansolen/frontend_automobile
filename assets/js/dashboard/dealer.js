...
//   );
  ...
  if (response.ok) {
    ...
    json.data.forEach((element) => {
      ...
      container += `<div class="col-md-6 mb-3">
          ...
          <div class="card-body">
              ...
              <div class="row">
                  ...
                  <div class="col-md-7">
                      ...
                      <small><i class="fas fa-user-tie"></i> Dealer</small>
                      <h5 class="card-title">${element.dealer_name}</h5>
                      <small><i class="fas fa-chart-area"></i> Area</small>
                      <h5 class="card-title">${element.area}</h5>
                      <small><i class="fas fa-location-arrow"></i> Address</small>
                      <h5 class="card-title">${element.address}</h5>
                      <small><i class="fas fa-phone"></i> Phone</small>
                      <h5 class="card-title">
                  ...
                  <div class="col-md-5 text-center">
                      <a class="btn btn-primary mb-2" href="#" id="btn_edit" data-id="${element.dealer_id}"><i class="fas fa-business-time"></i> View Inventory</a>
                  </div>
