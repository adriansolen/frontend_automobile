...
//   );
  ...
  if (response.ok) {
    ...
    json.data.forEach((element) => {
      ...
      <div class="card mt-3 shadow" data-id="${element.VIN}">
          <div class="row">
              <div class="col-md-12 d-flex align-items-center">
                  <img class="rounded" src="${backendURL}/storage/${element.image}" style="width: 100%; height: 200px; object-fit: cover;">
              </div>
              ...
              <div class="col-md-12 text-center mt-3 mb-2">
                  <a class="btn btn-primary" href="#" id="btn_edit" data-id="${element.VIN}"><i class="fa fa-shopping-bag"></i> Inquire</a>
              </div>
          </div>
      </div>
  </div>
